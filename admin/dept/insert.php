  ...
  <main id="main" class="main">
    ...
    <div class="card card-outline rounded-0 card-navy">
      <form method='POST' action='doinsert.php'>
        ...
        <div class="card-body">
          <table>
            <tr><th style = "width: 50px;">校區</th><td><input type='text' name='campus' value='和平校區'></td></tr>
            <tr><th style = "width: 50px;">建築</th><td><input type='text' name='building' value='文學院'></td></tr>
            <tr><th style = "width: 50px;">名稱</th><td><input type='text' name='name' value='誠101'></td></tr>
        </table>
        </div>
      </form>
    </div>
