    ...
    <div class="card card-outline rounded-0 card-navy">
      <div class="card-header ">
        <div class="card-tools d-flex justify-content-end">
          <form method="post">
            <button type="submit" name="user_button" class="my-button">使用者</button>
            <button type="submit" name="admin_button" class="my-button">管理員</button>
          </form>
        </div>
    </div>
    <div class="card-body">
              ...
              <thead><tr>
                ...
                <?php
                  ...
                  if (isset($_POST['admin_button'])){
                    ...
                    echo "<th style='width: 160px;'>管理</th></tr></thead><tbody>";
                    ...
                    if ($result->num_rows > 0) {
                      ...
                      while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><div class='oval-div' style='background-color: green;'><a style = 'color: white; text-decoration: none;' href='edit.php?ID={$row['ID']}'>審核</a></div>";
