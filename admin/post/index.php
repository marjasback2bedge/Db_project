    ...
    <div class="card card-outline rounded-0 card-navy">
      <div class="card-header ">
        <div class="card-tools d-flex justify-content-end">
					<form method="post">
            <button type="submit" name="lost_button" class="my-button">失物尋找</button>
            <button type="submit" name="found_button" class="my-button">拾獲招領</button>
          </form>
        </div>
    </div>
    <div class="card-body">
                ...
                if ($result->num_rows > 0) {
                  $i = 0;
                    ...
                    $i++;
										...
										echo "<td><a href='../user/edit.php?ID={$row['userID']}'>{$row['name']}</a></td>";
