  ...
  <main id="main" class="main">
    ...
    <div class="card-header ">
        <div class="card-tools d-flex justify-content-end">
            <input type='submit' name='insert' class="my-button" value='新增'/>
        </div>
    </div>

    <div class="card-body">
        <table>
            <tr><th style="width: 50px;">發現時間</th>
                <td><input type="datetime-local" name="occurtime" required></td>
            </tr>
            <tr><th style="width: 50px;">貼文種類</th>
                <td>
                    <select name="type" required>
                        <option value="0">失物</option>
                        <option value="1">招領</option>
                    </select>
                </td>
            </tr>
        </table>
