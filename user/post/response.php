...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="card card-outline rounded-0 card-navy">
      <form method='POST' action='doresponse.php'>
        
        <div class="card-header ">
          <div class="card-tools d-flex justify-content-end">
            <th colspan='2'><input type='submit' name='insert' class="my-button" value='新增'/></th></tr>
          </div>
        </div>

        <div class="card-body">
          <table>
            <!-- <tr><th style = "width: 50px;">使用者ID</th><td><input type='text' name='userID' value='和平校區'></td></tr> -->
            <tr><th style = "width: 50px;">貼文ID</th><td><input type='text' name='postID' value='<?php echo $ID; ?>' readonly></td></tr>
            <tr><th style = "width: 50px;">響應內容</th><td><input type='text' name='content' value='' required="required"></td></tr>
        </table>
        </div>
      </form>
    </div>
